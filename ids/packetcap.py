...
# sniffthread2=threading.Thread(target=scp.sniff,
#                              kwargs={
#                                  "prn":count_source_ips,
#                                  'filter':"",},
#                                  daemon=True
#                              )
# # Start the thread
    ...
    if event=='-startcap-':
        ...
        while True:
            ...
            if event == sg.TIMEOUT_EVENT:
                 ...
                 window["-givcount-"].update(values=pktsummarylist, scroll_to_index=len(pktsummarylist))
